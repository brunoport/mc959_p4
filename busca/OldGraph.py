...
class Graph:
	...
	def adjustActionForCorners(self):
		...
		transitionCorridor12DownRight = self.verticesDict["transitionCorridor1-2DownRight"]# transitionCorridor1-2DownRight
		transitionCorridor12DownLeft = self.verticesDict["transitionCorridor1-2DownLeft"]# transitionCorridor1-2DownLeft
